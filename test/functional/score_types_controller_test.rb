...
class ScoreTypesControllerTest < ActionController::TestCase
  ...
  test "should create score_type" do
    assert_difference('ScoreType.count') do
      post :create, :score_type => { :competition_id => @score_type.competition_id, :logic => @score_type.logic, :name => @score_type.name }
    end
  ...
  test "should update score_type" do
    put :update, :id => @score_type, :score_type => { :competition_id => @score_type.competition_id, :logic => @score_type.logic, :name => @score_type.name }
    assert_redirected_to score_type_path(assigns(:score_type))
  end
