...
class GameSetsControllerTest < ActionController::TestCase
  ...
  test "should create game_set" do
    assert_difference('GameSet.count') do
      post :create, :game_set => { :loser_id => @game_set.loser_id, :match_id => @game_set.match_id, :winner_id => @game_set.winner_id }
    end
  ...
  test "should update game_set" do
    put :update, :id => @game_set, :game_set => { :loser_id => @game_set.loser_id, :match_id => @game_set.match_id, :winner_id => @game_set.winner_id }
    assert_redirected_to game_set_path(assigns(:game_set))
  end
